...
function displayCategories() {
    ...
    if (variableCategories.length === 0) {
        container.innerHTML = '<p style="color: #6b7280; font-style: italic; padding: 1rem; text-align: center;">No hay categorías de gastos variables definidas. Haz clic en "Agregar Categoría" para crear una.</p>';
        return;
    }
